...
img1 = cv2.imread('C:/Users/HP/Downloads/2c5c30a58c233c1a2c4e728106356700.png', cv2.IMREAD_GRAYSCALE)

img2 = cv2.imread('C:/Users/HP/Downloads/2c5c30a58c233c1a2c4e728106356700.png', cv2.IMREAD_GRAYSCALE)
