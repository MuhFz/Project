...
def main():
    # Membaca gambar
    image1 = cv2.imread("C:/Users/HP/Downloads/2c5c30a58c233c1a2c4e728106356700.png", cv2.IMREAD_GRAYSCALE)  # Gambar pertama (Grayscale)
    image2 = cv2.imread("C:/Users/HP/Downloads/2c5c30a58c233c1a2c4e728106356700.png", cv2.IMREAD_GRAYSCALE)  # Gambar kedua (Grayscale)
