...
image1 = cv2.imread("C:/Users/HP/Downloads/2c5c30a58c233c1a2c4e728106356700.png", cv2.IMREAD_GRAYSCALE)
image2 = cv2.imread("C:/Users/HP/Downloads/2c5c30a58c233c1a2c4e728106356700.png", cv2.IMREAD_GRAYSCALE)

ksize = (10, 10) 
   
image2 = cv2.blur(image2, ksize)  
    

ssim_score = getSSISM(image1, image2)
