...
def showHistogramRGB(image, title):
    # Mengambil data warna merah, hijau dan biru dari citra
...
img = cv2.imread("C:/Users/HP/OneDrive/Documents/OneDrive/Pictures/preview (3).jpg")
...
titles = ['Original', 'Averaging Blur',
